...
# Favorite flavor of dorito : Spicy Nacho :o
# *****
...
# exponent is strictly decreasing
    ...
    def __sub__(self, other): # subPoly = myPoly - other
        ...
        return(other.__add__(self.polyList,other.polyList))
